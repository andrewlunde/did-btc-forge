...
import { buildDidDocument, decodeDidBtc, resolveDidBtc } from 'did-btc-sdk';
...
app.get("/.well-known/did.json", async (req, res) => {
    var exampleDidId = "";
    if (req.query.did && (typeof req.query.did == 'string')) {
        console.log("did: " + req.query.did);
        exampleDidId = req.query.did;
    }
    if (req.query.name) {
        console.log("name: " + req.query.name);
    }
    if (req.query.pkhex) {
        console.log("pkhex: " + req.query.pkhex);
    }
    var response = { "names": { "00000x0": "7bdef799f2278a58269cb96197691392b8a3e8f33c976a94deb242058a11b9b0" } };
    res.set('Content-Type', 'application/json');
